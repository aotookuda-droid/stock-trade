...
FIELD: list[Horse] = [
    Horse(1, 1, "ダノンデサイル",   "戸崎圭",  8.0, "差し", "◎",  6),
    Horse(2, 1, "ミュージアムマイル", "レーン",  4.8, "先行", "○",  8),
    Horse(3, 2, "シュガークン",     "吉村誠", 60.0, "先行", "○",  0),
    Horse(4, 2, "ミクニインスパイア", "丹内",  46.0, "先行", "▲",  2),
    Horse(5, 3, "クロワデュノール", "北村友",  2.5, "先行", "◎",  2),
    Horse(6, 3, "ビザンチンドリーム", "西村淳", 14.0, "追込", "○",  0),
    ...
    Horse(16, 8, "メイショウタバル", "武豊",   5.0, "逃げ", "◎",  6),
    Horse(17, 8, "レガレイラ",     "ルメール", 9.5, "追込", "○", 12),
...
# 当日の実オッズを入れるとEV計算に使う（キーは下記 bet_key() と同形式）。
#   例: ACTUAL_ODDS[("馬連", frozenset({5, 1}))] = 13.5
#       ACTUAL_ODDS[("3連複", frozenset({5, 1, 6}))] = 62.0
ACTUAL_ODDS: dict = {}
